...
<head>
  ...
  <title>Profile - Free Bulma template</title>
...
<body>
  <nav class="nav has-shadow" id="top">
    <div class="container">
      <div id="clipped-title" class="nav-left">
        <a class="nav-item" href="../index.html">
          <h1 class="logo-text">Rock Solid Granite</h1>
        </a>
      </div>
      ...
      <div class="columns">
        <div class="column is-2">
          <div class="image is-128x128 avatar">
            <img src="http://pinnaclegranite.com/wp-content/uploads/2014/03/A-J-Brown-300x184.jpg">
          </div>
        </div>
        <div class="column is-4 name">
          <p>
            <span class="title is-bold">AJ Brown</span>
            <span class="button is-primary is-outlined follow">Featured</span>
          </p>
          <p class="tagline">TAJ Brown granite has a gray and chocolate brown colored background with veins of amber and copper.</p>
        </div>
...
I178KL0LD334KI25.5KRank1.87KAge2014|03|26l0+10whoissourceMore dataSummary reportDiagnosisDensity00n/a
